...
🔑API HASH FRAGMENT - заходим на fragment.com и ЛКМ на любой юзернейм, после чего нажимаем на F12(ЛКМ - просмотреть код) и вкладку NETWORK, где находится app?hash="ваше значение". копируем его и вставляем в плагин.
🍪COOKIES - для куки нам потребуется расширение EditThisCookie, скачиваем его. после заходим на fragment.com, открываем расширение и берём оттуда куки в формате stel_ssid=...; stel_dt=...; stel_token=...; stel_ton_token=...
🔏МНЕМОНИКА - 24 секретных слова от кошелька tonkeeper, через пробел вставляем в плагин
👤User ID - ваш айди в телеграме, узнать его можно в боте @userinfobot
🔑Tonapi API Key - заходим на tonapi.io, создаём ключ и вставляем в плагин​
"""
